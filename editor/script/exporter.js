...
this.exportGame = function(gameData, title, pageColor, filename, isFixedSize, size, gamepadScript) {
	...
	html = replaceTemplateMarker( html, "@@H", gamepadScript || "" );
