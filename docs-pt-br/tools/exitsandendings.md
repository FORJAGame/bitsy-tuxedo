...
Saídas e finais são como o jogador se move entre salas, e como um jogo se conclui.

## Tipos

- **Exit (saída)** — uma conexão de mão dupla: ficar em cima dela em qualquer um dos salas manda o avatar pro local pareado. Saídas podem ligar dois salas diferentes, ou dois pontos do mesmo sala.
...
- **Marcadores de localização** — pré-visualizações em miniatura mostrando exatamente onde os pontos de entrada e (pras saídas) de saída ficam em seus salas. Você pode arrastar esses diretamente na visualização do sala, ou digitar coordenadas exatas da grade.
